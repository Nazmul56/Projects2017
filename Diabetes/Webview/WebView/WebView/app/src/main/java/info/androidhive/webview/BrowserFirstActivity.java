...
public class BrowserFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browserfirst);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Utils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(BrowserFirstActivity.this, BrowserFirstActivity.class);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(BrowserFirstActivity.this, BrowserActivity.class);
    ...
    private void initCollapsingToolbar() {
        ...
        Glide.with(getApplicationContext()).load("http://12v.comlu.com/ImageUpload/getimage.php?id=7")
                .thumbnail(0.5f)
                .crossFade()
