package com.droidking.diabetes.InAppBrowser;
...
public class BrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "file:///android_asset/index.html";//"https://api-project-745629179009.firebaseapp.com" ; // getIntent().getStringExtra("url");
